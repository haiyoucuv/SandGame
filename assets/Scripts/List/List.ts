...
export default class List extends cc.Component {
    ...
    @property({
        type: cc.Component.EventHandler,
        tooltip: CC_DEV && '附着改变事件',
    })
    private scrollToEvent: cc.Component.EventHandler = new cc.Component.EventHandler();
    ...
    _onTouchStart(ev, captureListeners) {
        if (this._scrollView['hasNestedViewGroup'] && this._scrollView['hasNestedViewGroup'](ev, captureListeners))
            return;
    ...
    _onTouchCancelled(ev, captureListeners) {
        let t = this;
        if ((t._scrollView['hasNestedViewGroup'] && t._scrollView['hasNestedViewGroup'](ev, captureListeners)) || ev.simulate)
            return;
    ...
    scrollTo(listId: number, timeInSecond: number = .5, offset: number = null, overStress: boolean = false) {
        ...
        cc.Component.EventHandler.emitEvents([t.scrollToEvent]);
